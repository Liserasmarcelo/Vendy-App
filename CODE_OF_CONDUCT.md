...
En el interés de fomentar un ambiente abierto y acogedor, nosotros como contribuidores y mantenedores nos comprometemos a hacer de la participación en nuestro proyecto y nuestra comunidad una experiencia libre de acoso para todos, independientemente de la edad, tamaño corporal, discapacidad, etnia, características sexuales, identidad y expresión de género, nivel de experiencia, educación, nivel socio-económico, nacionalidad, apariencia personal, raza, religión, o identidad y orientación sexual.
...
- Asumir buena fe en las interacciones
...
- Conducta que podría razonablemente considerarse inapropiada en un entorno profesional
...
Este Código de Conducta aplica dentro de todos los espacios del proyecto, y también aplica cuando una persona representa al proyecto o su comunidad en espacios públicos. Ejemplos de representación del proyecto incluyen usar un email oficial del proyecto, publicar a través de una cuenta oficial de redes sociales, o actuar como representante designado en un evento online o offline.
